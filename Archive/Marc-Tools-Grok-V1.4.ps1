...
# Set version
$version = "1.4"  # Updated for Batch 4
...
# New: Version check
try {
    $remoteVersion = Invoke-WebRequest -Uri "https://raw.githubusercontent.com/yourrepo/marc-tools/version.txt" -UseBasicParsing -ErrorAction SilentlyContinue | Select-Object -ExpandProperty Content
