...
<p><span style="font-weight: bold; color: red;">Location:</span> <span style="color: blue;">$location</span></p>
<p><span style="font-weight: bold; color: red;">Site Contact Name:</span> <span style="color: blue;">$contact ($phone)</span></p>
<p><span style="font-weight: bold; color: red;">Issue:</span> <span style="color: blue;">$description</span></p>
...
"@
            ...
            try {
                ...
                # Clean up: Close and release COM objects
                if ($dummyMail) {
                    $dummyMail.Close(1)  # 1 = olDiscard
                    [System.Runtime.Interopservices.Marshal]::ReleaseComObject($dummyMail) | Out-Null
                }
